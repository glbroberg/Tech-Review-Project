...
namespace ReviewProject.Controllers
{
    public class DeviceTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,DevTypeName")] DeviceType deviceType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,DevTypeName")] DeviceType deviceType)
        {
            if (ModelState.IsValid)
            {
