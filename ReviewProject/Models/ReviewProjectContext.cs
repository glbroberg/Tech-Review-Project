...
namespace ReviewProject.Models
{
    public class ReviewProjectContext : DbContext
    {
        ...
        public System.Data.Entity.DbSet<ReviewProject.Models.Brand> Brands { get; set; }

        public System.Data.Entity.DbSet<ReviewProject.Models.DeviceType> DeviceTypes { get; set; }
    }
}
